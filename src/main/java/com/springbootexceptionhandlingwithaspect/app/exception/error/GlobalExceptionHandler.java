package com.springbootexceptionhandlingwithaspect.app.exception.error;

import com.springbootexceptionhandlingwithaspect.app.exception.*;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleCategoryNotFoundException(CategoryNotFoundException ex) {
        ...
        ApiError err = new ApiError(HttpStatus.BAD_REQUEST.value(), HttpStatus.BAD_REQUEST, LocalDateTime.now() ,
                "Category Not Found", details);

        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(err);
    }

    // handleOrderItemNotFoundException : triggers when there is not resource with the specified ID in Category
    @ExceptionHandler(OrderItemNotFoundException.class)
    public ResponseEntity<Object> handleOrderItemNotFoundException(OrderItemNotFoundException ex) {

        List<String> details = new ArrayList<String>();
        details.add(ex.getMessage());

        ApiError err = new ApiError(HttpStatus.BAD_REQUEST.value(), HttpStatus.BAD_REQUEST, LocalDateTime.now() ,
                "OrderItem Not Found", details);
